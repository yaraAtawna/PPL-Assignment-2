...
export type Func = PrimOp | Closure;
export const functional = (x: any): x is Func => isPrimOp(x) || isClosure(x);
...
export const classValToStr=(clas:ClassValue):string=>'Class'
//==================object value
export type Object={
    tag:"Object";
    methods:Binding[];
...
export const makeObject=(methods:Binding[]):Object=>({tag:"Object",methods:methods,env:makeEmptyEnv()})

export const makeObjectEnv=(methods:Binding[],env:Env):Object=>({tag:"Object",methods:methods,env:env})
...
//==================
export type SExpValue = number | boolean | string | PrimOp | Closure |ClassValue |Object| SymbolSExp | EmptySExp | CompoundSExp;
...
export const ObjectTostring=(obj:Object):string=>'Object'
